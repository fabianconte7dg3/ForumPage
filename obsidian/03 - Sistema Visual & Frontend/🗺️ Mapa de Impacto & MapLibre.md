...
- **Mapa Base Real Geográfico (CartoDB Voyager / OpenStreetMap)**: Integración de mapa base real de alta definición con relieve, hidrografía, carreteras y toponimia completa de todos los poblados de Coclé Norte (*El Guabal*, *Atré*, *Churiquita Chiquita*, *Sofre*, *Vaquilla*, *Chiguirí Abajo*, *Chiguirí Arriba*, *El Caimito*, *Alto de San Miguel*, *Boca de Tulú*, *Boca de Cuiria*, *Las Marías*, *Uracillo Arriba*, *Río Indio*, *Cascajal*, *Las Lajas*, *Piedras Gordas*, *La Pintada*, *El Harino*, *Tulú*, *Toabré*, *Coclesito*).
