...
> **Actualización anterior (2026-08-10, 4):** Nueva pestaña "Importar" en `/staff`: el staff puede descargar una plantilla Excel por colección (Tutorías, Cursos, Talleres, Giras Educativas, Donaciones), llenarla con historial real de papel/Excel (con la fecha real de cuando ocurrió cada cosa) y subirla — filas inválidas se reportan una por una sin bloquear las válidas. Becarios históricos queda fuera de esta fase a propósito (consentimiento + cuentas de usuario, diseño aparte). Ver detalle completo en [docs/plan.md](file:///home/fabianc/Documentos/ForumPage/docs/plan.md).
