...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  ALTER TABLE "payload_locked_documents_rels" DROP CONSTRAINT IF EXISTS "payload_locked_documents_rels_horas_labor_social_fk";
  
  DROP INDEX IF EXISTS "payload_locked_documents_rels_horas_labor_social_id_idx";
